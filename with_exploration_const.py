...
exploration_minutes = 1.5
exploration_const = (exploration_minutes)/(0.1)
...
def choose_action(state, q_table, EPSILON):
    ...
    if (np.random.uniform() > (1-EPSILON)) or (state_actions.all() == 0):  # act non-greedy or state-action have no value
